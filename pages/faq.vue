            ...
            <div class="bg-white p-4 rounded-lg shadow-xl py-8 mt-12">
                ...
                <div class="space-y-12 px-2 xl:px-16 mt-12">
                    <div class="mt-4 flex">
                        ...
                        <div>
                            ...
                            <div class="flex items-center py-2">
                                <span class="text-gray-500">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae,
                    ...
                    <div class="mt-4 flex">
                        ...
                        <div>
                            <div class="flex items-center h-16">
                                <span class="text-lg text-blue-600 font-bold">Neque eos, dignissimos provident reiciendis
                                    debitis?</span>
                            </div>
                            <div class="flex items-center py-2">
                                <span class="text-gray-500">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae,
                    ...
                    <div class="mt-4 flex">
                        ...
                        <div>
                            <div class="flex items-center h-16">
                                <span class="text-lg text-blue-600 font-bold">Repudiandae commodi perferendis et
                                    itaque?</span>
                            </div>
                            <div class="flex items-center py-2">
                                <span class="text-gray-500">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae,
                    ...
                    <div class="mt-4 flex">
                        ...
                        <div>
                            <div class="flex items-center h-16">
                                <span class="text-lg text-blue-600 font-bold">Impedit iusto vitae dolorum, nostrum
                                    fugit?</span>
                            </div>
                            <div class="flex items-center py-2">
                                <span class="text-gray-500">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae,
